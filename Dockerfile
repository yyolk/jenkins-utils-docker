...
# RUN curl -L https://releases.hashicorp.com/packer/0.8.6/packer_0.8.6_linux_amd64.zip -o /var/jenkins_home/$PACKER_ZIP \
#   && echo "$PACKER_SHA /var/jenkins_home/$PACKER_ZIP" | sha1sum -c -
